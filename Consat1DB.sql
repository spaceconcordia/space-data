...
-- -----------------------------------------------------
-- Table `mydb`.`CommandUrgency`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`CommandUrgency` (
  `CommandUrgency_id` VARCHAR(10) NOT NULL,
  PRIMARY KEY (`CommandUrgency_id`),
...
CREATE TABLE IF NOT EXISTS `mydb`.`CommandPriority` (
  ...
  CONSTRAINT `CommandPriorityId_fk`
    FOREIGN KEY ()
    REFERENCES `mydb`.`CommandUrgency` ()
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
